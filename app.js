...
flow.register(new Scenes().supportusScene());
flow.register(new Scenes().doIhaveScene());
flow.register(new Scenes().ethioStatScene());
flow.register(new Scenes().whatshouldScene());
