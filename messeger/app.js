 ...
 * special keywords ('prompt', 'hi'), then we'll send back
...
function receivedMessage(event) {
  ...
  if (messageText) {
    ...
    switch (messageText.replace(/[^\w\s]/gi, '').trim().toLowerCase()) {
      ...
      case 'image':
        requiresServerURL(sendImageMessage, [senderID, 'moh.jpeg']);
        break;
...
Right now, this bot only responds to a few words. Try it out with "quick reply", "prompt" or "image".
      `
    }
  }
    ...
    message: {
      attachment: {
        ...
        payload: {
          ...
          text: "This is test prompt text",
          buttons:[{
            type: "web_url",
            url: "https://covid19.et/",
            title: "Open MoH URL"
          }, {
            type: "postback",
